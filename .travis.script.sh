...
source $CATKIN_WS_UNDERLAY/install/setup.bash > /dev/null # source install space of underlay
...
# build overlay
source $CATKIN_WS/devel/setup.bash > /dev/null # source devel space of overlay
